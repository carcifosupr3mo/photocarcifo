...
- **Fail2ban**: attivo sul server, con 7 jail configurate (verificato con `fail2ban-client status`): `nginx-botsearch`, `nginx-limit-req`, `pannello-login`, `photocarcifo-login`, `photocarcifo-scansioni`, `photocarcifo-scansioni-attivita`, `sshd`.
