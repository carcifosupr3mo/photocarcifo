...
TESTI.update({
    ...
    "js.supporto_aria": {"it": "Supporto al progetto", "en": "Project support",
        "fr": "Soutien au projet", "de": "Projektunterstützung", "es": "Apoyo al proyecto"},
    ...
    "js.supporto_copia": {"it": "Copia", "en": "Copy", "fr": "Copier", "de": "Kopieren", "es": "Copiar"},
    "js.supporto_copiato": {"it": "Copiato", "en": "Copied", "fr": "Copié", "de": "Kopiert", "es": "Copiado"},
    "js.supporto_copia_manuale": {"it": "Copia questo testo:", "en": "Copy this text:",
        "fr": "Copiez ce texte :", "de": "Diesen Text kopieren:", "es": "Copia este texto:"},
    "js.supporto_chiudi": {"it": "Grazie, chiudi", "en": "Thanks, close", "fr": "Merci, fermer",
        "de": "Danke, schließen", "es": "Gracias, cerrar"},
    "js.nome_titolo": {
