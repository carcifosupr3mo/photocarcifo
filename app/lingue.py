...
TESTI.update({
    ...
    "js.supporto_titolo": {"it": "Ti piace Photocarcifo?", "en": "Do you like Photocarcifo?",
        "fr": "Vous aimez Photocarcifo ?", "de": "Gefällt Ihnen Photocarcifo?",
        "es": "¿Te gusta Photocarcifo?"},
    "js.supporto_testo": {
        "it": "Le foto e le gallerie sono disponibili gratuitamente. Se vuoi supportare il progetto Photocarcifo e aiutarmi a continuare a creare contenuti, puoi lasciare un contributo volontario.",
        "en": "Photos and galleries are available for free. If you would like to support the Photocarcifo project and help me keep creating content, you can leave a voluntary contribution.",
        "fr": "Les photos et galeries sont disponibles gratuitement. Si vous souhaitez soutenir le projet Photocarcifo et m'aider à continuer à créer du contenu, vous pouvez laisser une contribution volontaire.",
        "de": "Fotos und Galerien stehen kostenlos zur Verfügung. Wenn Sie das Projekt Photocarcifo unterstützen und mir helfen möchten, weiterhin Inhalte zu erstellen, können Sie einen freiwilligen Beitrag hinterlassen.",
        "es": "Las fotos y galerías están disponibles de forma gratuita. Si quieres apoyar el proyecto Photocarcifo y ayudarme a seguir creando contenido, puedes dejar una contribución voluntaria."},
    "js.supporto_twint_label": {"it": "TWINT", "en": "TWINT", "fr": "TWINT", "de": "TWINT", "es": "TWINT"},
    "js.supporto_causale_label": {"it": "Causale", "en": "Reference", "fr": "Motif",
        "de": "Verwendungszweck", "es": "Concepto"},
    "js.supporto_causale_valore": {"it": "Foto", "en": "Foto", "fr": "Foto",
        "de": "Foto", "es": "Foto"},
    "js.supporto_iban_label": {"it": "IBAN", "en": "IBAN", "fr": "IBAN", "de": "IBAN", "es": "IBAN"},
    "js.supporto_twint_copiato": {"it": "Numero copiato", "en": "Number copied",
        "fr": "Numéro copié", "de": "Nummer kopiert", "es": "Número copiado"},
    "js.supporto_copia_aria": {"it": "tocca per copiare", "en": "tap to copy",
        "fr": "toucher pour copier", "de": "zum Kopieren tippen",
        "es": "toca para copiar"},
    "js.supporto_iban_copiato": {"it": "IBAN copiato", "en": "IBAN copied",
        "fr": "IBAN copié", "de": "IBAN kopiert", "es": "IBAN copiado"},
    "js.supporto_chiudi": {"it": "Chiudi", "en": "Close", "fr": "Fermer",
        "de": "Schließen", "es": "Cerrar"},
    "js.supporto_chiudi_frase": {"it": "Grazie per il supporto!", "en": "Thanks for your support!",
        "fr": "Merci pour votre soutien !", "de": "Danke für Ihre Unterstützung!",
